...
export default function PoolRadMain() {
    ...
    <><div className="row">
      <div className="col-md-6">
        ...
        <div className="row">
          ...
          <Functions.StrengthModule idText="strengthScore" dataArray={dataArray} setDataArray={setDataArray} extStrIndex={22} dataArrayIndex={16} />
        </div>
        <div className="row">
          <div className="col-4">Intelligence:</div>
          <div className="col-4">
            <Functions.ScoreModule dataArray={dataArray} setDataArray={setDataArray} dataArrayIndex={17} />
          </div>
        </div>
        <div className="row">
          <div className="col-4">Wisdom:</div>
          <div className="col-4">
            <Functions.ScoreModule dataArray={dataArray} setDataArray={setDataArray} dataArrayIndex={18} />
          </div>
        </div>
        <div className="row">
          <div className="col-4">Dexterity:</div>
          <div className="col-4">
            <Functions.ScoreModule dataArray={dataArray} setDataArray={setDataArray} dataArrayIndex={19} />
          </div>
        </div>
        <div className="row">
          <div className="col-4">Constitution:</div>
          <div className="col-4">
            <Functions.ScoreModule dataArray={dataArray} setDataArray={setDataArray} dataArrayIndex={20} />
          </div>
        </div>
        <div className="row">
          <div className="col-4">Charisma:</div>
          <div className="col-4">
            <Functions.ScoreModule dataArray={dataArray} setDataArray={setDataArray} dataArrayIndex={21} />
          </div>
        </div>
      </div>
      <div className="col-md-6">
        ...
        <div className="row">
          ...
          <div className="col-6">
            <Functions.LevelModule dataArray={dataArray} setDataArray={setDataArray} dataArrayIndex={151} />
          </div>
        </div>
        <div className="row">
          <div className="col-6">Fighter: </div>
          <div className="col-6">
            <Functions.LevelModule dataArray={dataArray} setDataArray={setDataArray} dataArrayIndex={152} />
          </div>
        </div>
        <div className="row">
          <div className="col-6">Magic-User: </div>
          <div className="col-6">
            <Functions.LevelModule dataArray={dataArray} setDataArray={setDataArray} dataArrayIndex={155} />
          </div>
        </div>
        <div className="row">
          <div className="col-6">Thief: </div>
          <div className="col-6">
            <Functions.LevelModule
              dataArray={dataArray}
  ...
  const arcaneMagicDisplay = <>
    ...
    <div className="row">
      <div className="col-2">
        1: <Functions.LevelModule dataArray={dataArray} setDataArray={setDataArray} dataArrayIndex={181} />
      </div>
      <div className="col-2">
        2: <Functions.LevelModule dataArray={dataArray} setDataArray={setDataArray} dataArrayIndex={182} />
      </div>
      <div className="col-2">
        3: <Functions.LevelModule dataArray={dataArray} setDataArray={setDataArray} dataArrayIndex={183} />
      </div>

    </div>
    <h4>Mage Spells:</h4>{" "}
    <div><Functions.SpellModule dataArray={dataArray} setDataArray={setDataArray} dataArrayMin={50} dataArrayMax={107} dataList={poolRadSpells} filter="Mage" /></div></>

  const clericMagicDisplay = <>
    <h4>Cleric Spell Slots</h4>
    <div className="row">
      <div className="col-2">
        1: <Functions.LevelModule dataArray={dataArray} setDataArray={setDataArray} dataArrayIndex={178} />
      </div>
      <div className="col-2">
        2: <Functions.LevelModule dataArray={dataArray} setDataArray={setDataArray} dataArrayIndex={179} />
      </div>
      <div className="col-2">
        3: <Functions.LevelModule dataArray={dataArray} setDataArray={setDataArray} dataArrayIndex={180} />
      </div>

    </div>
    <h4>Cleric Spells:</h4>{" "}
    <div><Functions.SpellModule dataArray={dataArray} setDataArray={setDataArray} dataArrayMin={50} dataArrayMax={107} dataList={poolRadSpells} filter="Cleric" /></div></>
