...
export function DisplayMain(props) {
  ...
  function loadFile(file) {
    ...
    reader.onload = function (e) {
      ...
      if (data.byteLength !== props.charByteLength) {
        return alert(
          `This doesn't appear to be a save file from ${props.gameName}`
        );
      } else {
  ...
  function CharInfoDisplay() {
    return (
      <CharComponents.CharInfoDisplay
        ...
        maxHPIndex={props.maxHPIndex} //done
        currentHPIndex={props.currentHPIndex} //done
        experienceIndex={props.experienceIndex} //done
        statusIndex={props.statusIndex} //done
        statusCodes={statusCodesList}
        racesList={racesList}
        raceIndex={props.raceIndex} // done
        genderIndex={props.genderIndex} //done
