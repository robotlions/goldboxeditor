...
import { azureItemValues } from "./AzureData";
import * as InvFunctions from "../InventoryFunctions";

export default function AzureInventory(props) {
  ...
  function loadFile(file) {
    ...
    reader.onload = function (e) {
      ...
      if(data.byteLength %63 !== 0){
        return alert("This does not appear to be an inventory file from Curse of the Azure Bonds")
      }
